  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        ...
        padding: EdgeInsets.fromLTRB(9 * fem, 21.27 * fem, 10 * fem, 0 * fem),
        width: double.infinity,
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(0 * fem, 0 * fem, 5.26 * fem, 13 * fem),
              width: 335.74 * fem,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          // vectorQ52 (2311:69)
                          margin: EdgeInsets.fromLTRB(
                              0 * fem, 0 * fem, 17.91 * fem, 2.27 * fem),
                          width: 10.09 * fem,
                          height: 13 * fem,
                          child: Image.asset(
                        ...
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(
                              0 * fem, 0.73 * fem, 157.26 * fem, 0 * fem),
                          child: Text(
                            'Book Appointment',
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(5 * fem, 0 * fem, 10 * fem, 7 * fem),
              width: double.infinity,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: ClipRRect(
                        borderRadius:
                            BorderRadius.circular(17.8666667938 * fem),
                        child: Image.asset(
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(12 * fem, 0 * fem, 15 * fem, 5 * fem),
              width: double.infinity,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
            ...
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(14 * fem, 0 * fem, 15 * fem, 34 * fem),
              width: double.infinity,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                    ...
                    children: [
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              fit: BoxFit.cover,
                              image:
                                  AssetImage('assets/images/skinallergy.jpg'),
                            ),
                          ),
                        ),
                      ),
                      ...
                      GestureDetector(
                        onTap: () {
                          // Handle the click event for the third image.
                          // You can replace the below line with your desired action.
                          print('Reproductive Health Image Clicked!');
                        },
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              fit: BoxFit.cover,
                              image: AssetImage('assets/images/rephealth.jpg'),
                            ),
                          ),
                        ),
                      ),
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              fit: BoxFit.cover,
                              image: AssetImage('assets/images/eyeissues.jpg'),
                            ),
                          ),
                        ),
                      ),
            ...
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(14 * fem, 0 * fem, 22 * fem, 11 * fem),
              width: double.infinity,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          fit: BoxFit.cover,
                          image: AssetImage('assets/images/sleepdis.jpg'),
                        ),
                      ),
                    ),
                  ),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          fit: BoxFit.cover,
                          image: AssetImage('assets/images/bone.jpg'),
                        ),
                      ),
                    ),
                  ),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          fit: BoxFit.cover,
                          image: AssetImage('assets/images/respiratory.jpg'),
                        ),
                      ),
                    ),
                  ),
            ...
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(11 * fem, 0 * fem, 7.5 * fem, 0 * fem),
              width: double.infinity,
              child:
                ...
                Container(
                  ...
                  margin:
                      EdgeInsets.fromLTRB(0 * fem, 4 * fem, 39 * fem, 0 * fem),
                  child: Text(
                    'Sleep Disorder',
                    textAlign: TextAlign.center,
                    style: GoogleFonts.lato(
                ...
                Container(
                  ...
                  margin:
                      EdgeInsets.fromLTRB(0 * fem, 0 * fem, 11 * fem, 4 * fem),
                  child: Text(
                    'Bone and Joint',
                    textAlign: TextAlign.center,
                    style: GoogleFonts.lato(
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          fit: BoxFit.cover,
                          image: AssetImage('assets/images/stomachpain.jpg'),
                        ),
                      ),
                    ),
                  ),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          fit: BoxFit.cover,
                          image: AssetImage('assets/images/highbp.jpg'),
                        ),
                      ),
                    ),
                  ),
            ...
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(14 * fem, 0 * fem, 27.5 * fem, 12 * fem),
              width: double.infinity,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
