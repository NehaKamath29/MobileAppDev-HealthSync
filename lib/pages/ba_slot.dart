...
class _BaSlotClassState extends State<BaSlotClass> {
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(14 * fem, 0 * fem, 7 * fem, 0 * fem),
              padding:
                  EdgeInsets.fromLTRB(12 * fem, 17 * fem, 18 * fem, 38 * fem),
              width: double.infinity,
              decoration: BoxDecoration(
  ...
  try {
    ...
    int currentPatientsCount = int.parse(userData['patients_count']?? '0');

    // Update the data with the incremented value
    Map<String, dynamic> newData = {
      'patients_count': (currentPatientsCount + 1) ?? '0',
...
// class YourWidget extends State<BaSlotClass> {
//   YourWidget({required this.userData});
