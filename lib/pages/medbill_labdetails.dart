  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        ...
        padding: EdgeInsets.fromLTRB(5 * fem, 11.47 * fem, 5 * fem, 29 * fem),
        width: double.infinity,
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(7.55 * fem, 0 * fem, 56 * fem, 12 * fem),
              width: double.infinity,
              child: Row(
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(10 * fem, 0 * fem, 14 * fem, 4 * fem),
              padding:
                  EdgeInsets.fromLTRB(26 * fem, 9 * fem, 26 * fem, 8 * fem),
              width: double.infinity,
              decoration: BoxDecoration(
            ...
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(14 * fem, 0 * fem, 10 * fem, 13 * fem),
              padding:
                  EdgeInsets.fromLTRB(22 * fem, 14 * fem, 22 * fem, 19 * fem),
              width: double.infinity,
              decoration: BoxDecoration(
                border: Border.all(color: Color(0xff005d92)),
                color: Color(0xffc5edff),
