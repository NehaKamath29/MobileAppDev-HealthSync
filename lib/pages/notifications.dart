  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        ...
        padding: EdgeInsets.fromLTRB(0 * fem, 10.72 * fem, 0 * fem, 0 * fem),
        width: double.infinity,
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(16 * fem, 0 * fem, 16 * fem, 119 * fem),
              width: double.infinity,
              height: 104 * fem,
              decoration: BoxDecoration(
                border: Border.all(color: Color(0xffedebf3)),
            ...
            Container(
              // componentnavbarSSY (2315:342)
              width: 360 * fem,
              height: 93 * fem,
              child: Image.asset(
                'assets/images/component-nav-bar-idi.png',
                width: 360 * fem,
                height: 93 * fem,
              ),
            ),
