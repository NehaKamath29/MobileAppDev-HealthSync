  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        ...
        padding:
            EdgeInsets.fromLTRB(11.55 * fem, 11.47 * fem, 16 * fem, 49 * fem),
        width: double.infinity,
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(9.45 * fem, 0 * fem, 32 * fem, 7 * fem),
              width: double.infinity,
              height: 187 * fem,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
            ...
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(12.45 * fem, 0 * fem, 0 * fem, 2 * fem),
              constraints: BoxConstraints(
                maxWidth: 114 * fem,
              ),
              child: Text(
            ...
            Container(
              // mbbsmddHE (2315:227)
              margin:
                  EdgeInsets.fromLTRB(12.45 * fem, 0 * fem, 0 * fem, 12 * fem),
              child: Text(
                'MBBS, MD ',
                style: safeGoogleFont(
                  'Lato',
            ...
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(5.45 * fem, 0 * fem, 0 * fem, 23 * fem),
              padding:
                  EdgeInsets.fromLTRB(22 * fem, 16 * fem, 22 * fem, 15 * fem),
              width: 326 * fem,
              decoration: BoxDecoration(
            ...
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(6.45 * fem, 0 * fem, 0 * fem, 0 * fem),
              width: 326 * fem,
              height: 318 * fem,
              decoration: BoxDecoration(
                border: Border.all(color: Color(0xff005d92)),
