      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
             padding: EdgeInsets.fromLTRB(20*fem, 8*fem, 20*fem, 45*fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
              ...
              child: Ink.image(
              image: const AssetImage('assets/images/reportsTrackImg.png'),
              fit: BoxFit.cover,
              width: 320 * fem,
              height: 130 * fem,
              child: InkWell(
              ...
              child: Ink.image(
              image: const AssetImage('assets/images/periodsTrackimg.png'),
              fit: BoxFit.cover,
              width: 320 * fem,
              height: 130 * fem,
              child: InkWell(
